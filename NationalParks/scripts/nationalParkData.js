...
window.onload = function () {
    // Link up elements from HTML document by declaring their variables
    ...
    // Add .onchange event handler to location dropdown to display national parks' info when a park is chosen
 locationDropdown.onchange = function () {
    const selectedLocationId = locationDropdown.value;
    if (selectedLocationId) {
        const selectedLocation = nationalParksArray.find(nationalParkInfo => nationalParkInfo.LocationID == selectedLocationId);
